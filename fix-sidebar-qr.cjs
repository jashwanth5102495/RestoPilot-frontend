...
// 1. Add QR Orders button before </aside>
const oldAside = `        <button
...
// 2. Add QR Orders button in mobile header
...
console.log("Navigation bars updated!");
